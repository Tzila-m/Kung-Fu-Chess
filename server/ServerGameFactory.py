...
def create_server_game(pieces_root: str | pathlib.Path, img_factory) -> ServerGame:
    """Build a *ServerGame* from the on-disk asset hierarchy rooted at *pieces_root*.
    ...
    and returns a ready-to-run *ServerGame* instance.
    """
