...
GUI application for the white player
"""
import sys
import asyncio
import logging
...
class GameClient(QObject):
    ...
    async def start(self):
        ...
        self.ws_client = create_client(self.server_url, "white")
...
class ChessClientApp:
    ...
    async def run(self):
        ...
        # Create game widget for white player
        self.game_widget = ChessGameWidget("white")
...
async def main():
    """Main entry point"""
    logger.info("Starting Kung Fu Chess White Client")
